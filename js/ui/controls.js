...
export const CONTROLS = [
  ...
  { id: 'road',   code: 'ROAD',  name: 'Road to 45',    group: 'Readouts', kind: 'read',
    tip: 'The board: 45 points, which you hold, and what the next one costs' },
  { id: 'proj',   code: 'PROJ',  name: 'Projection',    group: 'Readouts', kind: 'read',
    tip: 'Every score logged, predicted grades and the TOK/EE matrix' },
  ...
  { id: 'quests', code: 'QST',   name: 'Missions',    group: 'Systems', kind: 'sys',
    tip: 'Today’s objectives and this week’s — prompts towards ground, not points' },
